...
class ChartWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        *,
        ...
        self.chart = chart
        self.right_panel = ChartRightPanel(initial_script=initial_script)
    ...
    def run_condition_script(self, script: str) -> None:
        ...
        if not script.strip():
            ...
            self.right_panel.show_error("Condition scripts cannot be empty.")
            return
